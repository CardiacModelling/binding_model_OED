...
binding = {
    ...
    'm1-td': binding_mx('lei', 1),
    'm2-td': binding_mx('lei', 2),
    'm2i-td': binding_mx_re('m2i'),
    'm3-td': binding_mx('lei', 3),
    'm4-td': binding_mx('lei', 4),
    'm5-td': binding_mx('lei', 5),
    'm5i-td': binding_mx_re('m5i'),
    'm6-td': binding_mx('lei', 6),
    'm7-td': binding_mx('lei', 7),
    'm8-td': binding_mx('lei', 8),
    'm9-td': binding_mx('lei', 9),
    'm10-td': binding_mx('lei', 10),
    'm11-td': binding_mx('lei', 11),
    'm12-td': binding_mx('lei', 12),
    'm3-td': binding_mx('lei', 13),
    'kemp-m1': binding_mx('lei', 1),
    'kemp-m2': binding_mx('lei', 2),
    'kemp-m2i': binding_mx_re('m2i'),
    'kemp-m3': binding_mx('lei', 3),
    'kemp-m4': binding_mx('lei', 4),
    'kemp-m5': binding_mx('lei', 5),
    'kemp-m5i': binding_mx_re('m5i'),
    'kemp-m6': binding_mx('lei', 6),
    'kemp-m7': binding_mx('lei', 7),
    'kemp-m8': binding_mx('lei', 8),
    'kemp-m9': binding_mx('lei', 9),
    'kemp-m10': binding_mx('lei', 10),
    'kemp-m11': binding_mx('lei', 11),
    'kemp-m12': binding_mx('lei', 12),
    'kemp-m13': binding_mx('lei', 13),
    'sis-m1': binding_mx('lei', 1),
    'sis-m2': binding_mx('lei', 2),
    'sis-m2i': binding_mx_re('m2i'),
    'sis-m3': binding_mx('lei', 3),
    'sis-m4': binding_mx('lei', 4),
    'sis-m5': binding_mx('lei', 5),
    'sis-m5i': binding_mx_re('m5i'),
    'sis-m6': binding_mx('lei', 6),
    'sis-m7': binding_mx('lei', 7),
    'sis-m8': binding_mx('lei', 8),
    'sis-m9': binding_mx('lei', 9),
    'sis-m10': binding_mx('lei', 10),
    'sis-m11': binding_mx('lei', 11),
    'sis-m12': binding_mx('lei', 12),
    'sis-m13': binding_mx('lei', 13),
    'li': binding_li,
...
def binding_mx_fh(m):
    o = {}
    if m in ['m12', 'm13', 'li-m12', 'li-m13', 'kemp-m12', 'kemp-m13', 'sis-m12', 'sis-m13']:
        for drug in _drug_list:
...
binding_fix_hill = {
    ...
    'm1-td': binding_mx_fh('m1'),
    'm2-td': binding_mx_fh('m2'),
    'm2i-td': binding_mx_fh('m2i'),
    'm3-td': binding_mx_fh('m3'),
    'm4-td': binding_mx_fh('m4'),
    'm5-td': binding_mx_fh('m5'),
    'm5i-td': binding_mx_fh('m5i'),
    'm6-td': binding_mx_fh('m6'),
    'm7-td': binding_mx_fh('m7'),
    'm8-td': binding_mx_fh('m8'),
    'm9-td': binding_mx_fh('m9'),
    'm10-td': binding_mx_fh('m10'),
    'm11-td': binding_mx_fh('m11'),
    'm12-td': binding_mx_fh('m12'),
    'm13-td': binding_mx_fh('m13'),
    'kemp-m1': binding_mx_fh('m1'),
    'kemp-m2': binding_mx_fh('m2'),
    'kemp-m2i': binding_mx_fh('m2i'),
    'kemp-m3': binding_mx_fh('m3'),
    'kemp-m4': binding_mx_fh('m4'),
    'kemp-m5': binding_mx_fh('m5'),
    'kemp-m5i': binding_mx_fh('m5i'),
    'kemp-m6': binding_mx_fh('m6'),
    'kemp-m7': binding_mx_fh('m7'),
    'kemp-m8': binding_mx_fh('m8'),
    'kemp-m9': binding_mx_fh('m9'),
    'kemp-m10': binding_mx_fh('m10'),
    'kemp-m11': binding_mx_fh('m11'),
    'kemp-m12': binding_mx_fh('m12'),
    'kemp-m13': binding_mx_fh('m13'),
    'sis-m1': binding_mx_fh('m1'),
    'sis-m2': binding_mx_fh('m2'),
    'sis-m2i': binding_mx_fh('m2i'),
    'sis-m3': binding_mx_fh('m3'),
    'sis-m4': binding_mx_fh('m4'),
    'sis-m5': binding_mx_fh('m5'),
    'sis-m5i': binding_mx_fh('m5i'),
    'sis-m6': binding_mx_fh('m6'),
    'sis-m7': binding_mx_fh('m7'),
    'sis-m8': binding_mx_fh('m8'),
    'sis-m9': binding_mx_fh('m9'),
    'sis-m10': binding_mx_fh('m10'),
    'sis-m11': binding_mx_fh('m11'),
    'sis-m12': binding_mx_fh('m12'),
    'sis-m13': binding_mx_fh('m13'),
...
_model_current = {
    ...
    'm10-td': 'ikr.IKr',
    'm11-td': 'ikr.IKr',
    'm12-td': 'ikr.IKr',  # Li et al. binding model
    'm13-td': 'ikr.IKr',
    'kemp-m1': 'ikr.IKr',
    'kemp-m2': 'ikr.IKr',
    'kemp-m2i': 'ikr.IKr',
...
_model_dose = {
    ...
    'm10-td': 'ikr.D',
    'm11-td': 'ikr.D',
    'm12-td': 'ikr.D',  # Li et al. binding model
    'm13-td': 'ikr.D',
    'kemp-m1': 'ikr.D',
    'kemp-m2': 'ikr.D',
    'kemp-m2i': 'ikr.D',
...
_model_conductance = {
    ...
    'm10-td': ['ikr.p9'],
    'm11-td': ['ikr.p9'],
    'm12-td': ['ikr.p9'],  # Li et al. binding model
    'm13-td': ['ikr.p9'],
    'kemp-m1': ['ikr.gkr'],
    'kemp-m2': ['ikr.gkr'],
    'kemp-m2i': ['ikr.gkr'],
    ...
    'sis-m10': ['ikr.p9'],
    'sis-m11': ['ikr.p9'],
    'sis-m12': ['ikr.p9'],  # Li et al. binding model
    'sis-m13': ['ikr.p9'],
    'li': ['ikr.GKr'],
    'li-m0a': ['ikr.g'],
    'li-m0b': ['ikr.g'],
...
kinetics_kemp = ['ikr.kf', 'ikr.kb', 'ikr.a_12', 'ikr.a_3O', 'ikr.a_OI', 'ikr.a_3I',
                 'ikr.b_21', 'ikr.b_O3', 'ikr.b_IO', 'ikr.b_I3', 'ikr.z_12', 'ikr.z_3O',
                 'ikr.z_OI', 'ikr.z_3I', 'ikr.z_21', 'ikr.z_O3', 'ikr.z_IO', 'ikr.z_I3']
...
_model_kinetics = {
    ...
    'm13': kinetics_lei,
    'm1-td': kinetics_lei_td,
    'm2-td': kinetics_lei_td,
    'm2i-td': kinetics_lei_td,
    'm3-td': kinetics_lei_td,
    'm4-td': kinetics_lei_td,
    'm5-td': kinetics_lei_td,
    'm5i-td': kinetics_lei_td,
    'm6-td': kinetics_lei_td,
    'm7-td': kinetics_lei_td,
    'm8-td': kinetics_lei_td,
    'm9-td': kinetics_lei_td,
    'm10-td': kinetics_lei_td,
    'm11-td': kinetics_lei_td,
    'm12-td': kinetics_lei_td,  # Li et al. binding model
    'm13-td': kinetics_lei_td,
    'sis-m1': kinetics_lei,
    'sis-m2': kinetics_lei,
    'sis-m2i': kinetics_lei,
    'sis-m3': kinetics_lei,
    'sis-m4': kinetics_lei,
    'sis-m5': kinetics_lei,
    'sis-m5i': kinetics_lei,
    'sis-m6': kinetics_lei,
    'sis-m7': kinetics_lei,
    'sis-m8': kinetics_lei,
    'sis-m9': kinetics_lei,
    'sis-m10': kinetics_lei,
    'sis-m11': kinetics_lei,
    'sis-m12': kinetics_lei,  # Li et al. binding model
    'sis-m13': kinetics_lei,
    'kemp-m1': kinetics_kemp,
    'kemp-m2': kinetics_kemp,
    'kemp-m2i': kinetics_kemp,
    'kemp-m3': kinetics_kemp,
    'kemp-m4': kinetics_kemp,
    'kemp-m5': kinetics_kemp,
    'kemp-m5i': kinetics_kemp,
    'kemp-m6': kinetics_kemp,
    'kemp-m7': kinetics_kemp,
    'kemp-m8': kinetics_kemp,
    'kemp-m9': kinetics_kemp,
    'kemp-m10': kinetics_kemp,
    'kemp-m11': kinetics_kemp,
    'kemp-m12': kinetics_kemp,
    'kemp-m13': kinetics_kemp,
    'li': [],
    'li-m0a': kinetics_li,
    'li-m0b': kinetics_li,
    'li-m1': kinetics_li,
...
_model_binding = {
    ...
    'm1-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm2-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm2i-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm3-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm4-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm5-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm5i-td': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'm6-td': ['ikr.kon', 'ikr.koff', 'ikr.k2f', 'ikr.hill'],
    'm7-td': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.koff_i', 'ikr.hill'],
    'm8-td': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'm9-td': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'm10-td': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.k2f', 'ikr.hill'],
    'm11-td': ['ikr.kon', 'ikr.koff', 'ikr.ku', 'ikr.kt', 'ikr.hill'],
    'm12-td': ['ikr.kt', 'ikr.kmax', 'ikr.ku', 'ikr.halfmax', 'ikr.hill',
            'ikr.vhalf'],
    'm13-td': ['ikr.kt', 'ikr.kforward', 'ikr.ku', 'ikr.hill', 'ikr.vhalf'],
    'sis-m1': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m2': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m2i': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m3': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m4': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m5': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m5i': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'sis-m6': ['ikr.kon', 'ikr.koff', 'ikr.k2f', 'ikr.hill'],
    'sis-m7': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.koff_i', 'ikr.hill'],
    'sis-m8': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'sis-m9': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'sis-m10': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.k2f', 'ikr.hill'],
    'sis-m11': ['ikr.kon', 'ikr.koff', 'ikr.ku', 'ikr.kt', 'ikr.hill'],
    'sis-m12': ['ikr.kt', 'ikr.kmax', 'ikr.ku', 'ikr.halfmax', 'ikr.hill',
            'ikr.vhalf'],
    'sis-m13': ['ikr.kt', 'ikr.kforward', 'ikr.ku', 'ikr.hill', 'ikr.vhalf'],
    'kemp-m1': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m2': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m2i': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m3': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m4': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m5': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m5i': ['ikr.kon', 'ikr.koff', 'ikr.hill'],
    'kemp-m6': ['ikr.kon', 'ikr.koff', 'ikr.k2f', 'ikr.hill'],
    'kemp-m7': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.koff_i', 'ikr.hill'],
    'kemp-m8': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'kemp-m9': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.hill'],
    'kemp-m10': ['ikr.kon_o', 'ikr.koff_o', 'ikr.kon_i', 'ikr.k2f', 'ikr.hill'],
    'kemp-m11': ['ikr.kon', 'ikr.koff', 'ikr.ku', 'ikr.kt', 'ikr.hill'],
    'kemp-m12': ['ikr.kt', 'ikr.kmax', 'ikr.ku', 'ikr.halfmax', 'ikr.hill',
            'ikr.vhalf'],
    'kemp-m13': ['ikr.kt', 'ikr.kforward', 'ikr.ku', 'ikr.hill', 'ikr.vhalf'],
