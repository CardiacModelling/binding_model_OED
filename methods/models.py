...
from .parameters import _model_binding
...
_model_files = {
    ...
    'sis-m3': 'lei-2019-m3RTsis.mmt',
    'sis-m4': 'lei-2019-m4RTsis.mmt',
    'sis-m5': 'lei-2019-m5RTsis.mmt',
    'sis-m5i': 'lei-2019-m5iRTsis.mmt',
    'sis-m6': 'lei-2019-m6RTsis.mmt',
    'sis-m7': 'lei-2019-m7RTsis.mmt',
    'sis-m8': 'lei-2019-m8RTsis.mmt',
    'sis-m9': 'lei-2019-m9RTsis.mmt',
    'sis-m10': 'lei-2019-m10RTsis.mmt',
    'sis-m11': 'lei-2019-m11RTsis.mmt',
    'sis-m12': 'lei-2019-m12RTsis.mmt',  # Li et al. 2017 binding model
    'sis-m13': 'lei-2019-m13RTsis.mmt',
    'kemp-m1': 'kemp-m1.mmt',
    'kemp-m2': 'kemp-m2.mmt',
    'kemp-m2i': 'kemp-m2i.mmt',
    'kemp-m3': 'kemp-m3.mmt',
    'kemp-m4': 'kemp-m4.mmt',
    'kemp-m5': 'kemp-m5.mmt',
    'kemp-m5i': 'kemp-m5i.mmt',
    'kemp-m6': 'kemp-m6.mmt',
    'kemp-m7': 'kemp-m7.mmt',
    'kemp-m8': 'kemp-m8.mmt',
    'kemp-m9': 'kemp-m9.mmt',
    'kemp-m10': 'kemp-m10.mmt',
    'kemp-m11': 'kemp-m11.mmt',
    'kemp-m12': 'kemp-m12.mmt',  # Li et al. 2017 binding model
    'kemp-m13': 'kemp-m13.mmt',
    'li': 'li-2017.mmt',
...
class Model(pints.ForwardModel):
        ...
        if not self.analytical:
            ...
            if self._model_name[0] == 'm':
                self.m = markov.LinearModel.from_component(
                    ...
                    parameters=self.PARAM + [self._model_dose] + ['physical_constants.T', 'ikr.p1', 'ikr.p2', 'ikr.p3', 'ikr.p4',
    ...
    def change_protocol(self, protocol_def):
        # Update protocol
        if self.analytical:
            if type(protocol_def) is str:
                self.p = myokit.load_protocol(protocol_def)
            ...
            print("Needs to be analytical sim to change protocol")
